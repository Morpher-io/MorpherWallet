...
describe('Passwords', () => {
	...
	it('Error on Change Password Incorrect Password', () => {
		...
		cy.get('[data-cy=oldPassword]').type(incorrectPassword).should('have.value', incorrectPassword);

		cy.get('[data-cy=newPassword]').type(newPassword).should('have.value', newPassword);

		cy.get('[data-cy=newPasswordRepeat]').type(newPassword).should('have.value', newPassword);
	...
	it('Successfully Change Password', () => {
		...
		cy.get('[data-cy=oldPassword]').type(password).should('have.value', password);
	...
	it('Successfully Change Password Back to Original', () => {
		...
		cy.get('[data-cy=oldPassword]').type(newPassword).should('have.value', newPassword);

		cy.get('[data-cy=newPassword]').type(password).should('have.value', password);

		cy.get('[data-cy=newPasswordRepeat]').type(password).should('have.value', password);
