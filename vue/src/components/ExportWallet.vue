			...
			<div>
				<div class="message-body">
					...
					<div class="field">
						...
						<div class="control">
							<input class="input is-primary" name="password" type="password" data-cy="password" v-model="password" />
						</div>
					</div>
					<h2 class="title has-text-left">Seed Phrase</h2>
					<p class="subtitle is-text-small has-text-left">Enter your password above to manipulate seed pharse.</p>
					<div class="is-flex">
						<button
						...
						<button
							data-cy="showSeed"
							class="button is-grey outlined-button big-button transition-faster small-text squared ml-3"
							type="submit"
							@click="showPhrase()"
							:disabled="!password"
						>
					...
					<div class="private-key" v-if="store.seedPhrase !== ''">
						...
						<button
							data-cy="clearSeed"
							class="button big-button is-danger transition-faster small-text mt-3"
							@click="clearPhrase()"
							type="submit"
						>
							<span>Clear</span>
					...
					<h2 class="title has-text-left">Private Key</h2>
					<p class="subtitle is-text-small has-text-left">Enter your password above to export private key.</p>
					<div class="is-flex">
						<button
							class="button is-green big-button is-login transition-faster"
							data-cy="exportSeed"
							type="submit"
							@click="exportKey(store.accounts[0])"
							:disabled="!password"
						>
